...
public class ThreadClassProrityBackground implements IExperiment{

    private static final String TAG = "ThreadPriorityBack";
    ...
    private static ThreadFactory getThreadFactory() {
        return new ThreadFactory() {
            ...
            int mThreadPriority = Process.THREAD_PRIORITY_BACKGROUND;
